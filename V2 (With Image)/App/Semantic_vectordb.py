...
# Load VectorDB
index = faiss.read_index("./db/vectordb/index.faiss")
with open("./db/vectordb/mapping_data.json", "r", encoding="utf-8") as file:
...
wrong_responses = [
    ...
    "Rất tiếc, câu hỏi này nằm ngoài khả năng hiện tại của tôi. Nếu bạn cung cấp email, chúng tôi sẽ nhờ chuyên gia tư vấn và phản hồi cho bạn trong thời gian sớm nhất.",
    "Rất xin lỗi, tôi chưa có đủ kiến thức để trả lời câu hỏi này. Bạn có thể để lại email, và chúng tôi sẽ nhờ chuyên gia phản hồi cụ thể cho bạn.",
    "Xin lỗi, tôi chưa được đào tạo về câu hỏi này. Bạn có thể để lại email, và chúng tôi sẽ kết nối bạn với chuyên gia của SkinChat.",
    ...
    "Xin lỗi, câu hỏi này vượt ngoài nội dung tôi đã học. Hãy để lại email để chúng tôi có thể liên hệ chuyên gia hỗ trợ bạn chi tiết hơn.",
    ...
    "Rất xin lỗi, tôi chưa có đủ thông tin để trả lời câu hỏi này. Nếu bạn đồng ý, hãy cung cấp email để chuyên gia SkinChat phản hồi kịp thời cho bạn.",
    "Xin lỗi, tôi chưa thể đưa ra câu trả lời chính xác. Nếu bạn để lại email, chúng tôi sẽ sắp xếp để chuyên gia của chúng tôi tư vấn thêm.",
